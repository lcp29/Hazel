...
namespace Aster
{
    struct RenderTextureAssetMeta
    {
        ...
        {
            if (m_Desc.height == height) { return; }
        ...
        {
            if (m_Desc.arrayLayers == arrayLayers) { return; }
        ...
        {
            if (m_Desc.viewType == viewType) { return; }
        ...
        {
            if (m_Desc.useMipmap == useMipmap) { return; }
        ...
        {
            if (m_Desc.perFrame == perFrame) { return; }
        ...
        {
            if (m_Desc.format == format) { return; }
        ...
        {
            if (m_Desc.usages == usages) { return; }
    ...
    class RenderTextureAsset : public Asset
    {
      public:
        ...
        const RenderTextureAssetMeta& GetMeta() const { return m_Meta; }

        RenderTextureAssetMeta& GetMeta() { return m_Meta; }
