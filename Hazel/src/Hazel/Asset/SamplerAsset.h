...
namespace Hazel
{
    ...
    struct SamplerAssetMeta
    {
        ...
        {
            if (m_Desc.addressModeU == addressModeU)
            {
                return;
            }
        ...
        {
            if (m_Desc.addressModeV == addressModeV)
            {
                return;
            }
        ...
        {
            if (m_Desc.addressModeW == addressModeW)
            {
                return;
            }
        ...
        {
            if (m_Desc.mipLodBias == mipLodBias)
            {
                return;
            }
        ...
        {
            if (m_Desc.maxAnisotropy == maxAnisotropy)
            {
                return;
            }
        ...
        {
            if (m_Desc.enableAnisotropy == enableAnisotropy)
            {
                return;
            }
        ...
        {
            if (m_Desc.compareEnable == compareEnable)
            {
                return;
            }
