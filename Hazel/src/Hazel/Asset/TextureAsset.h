...
namespace Aster
{
    ...
    struct TextureAssetMeta
    {
        ...
        {
            if (m_UseMipmap == useMipmap) { return; }
            m_UseMipmap = useMipmap;
            m_Version++;
        }

        bool AllowStorageLoad() const { return m_AllowStorageLoad; }

        void SetAllowStorageLoad(bool allowStorageLoad)
        {
            if (m_AllowStorageLoad == allowStorageLoad) { return; }
    ...
    class TextureAsset : public Asset
    {
      public:
        ...
        TextureAsset(AssetRegistryTerm* registryTerm, const TextureAssetMeta& meta, TextureAssetData textureData)
            : Asset(registryTerm)
            , m_Meta(meta)
        ...
        const TextureAssetMeta& GetMeta() const { return m_Meta; }

        TextureAssetMeta& GetMeta() { return m_Meta; }

        const TextureAssetData& GetTextureData() const { return m_TextureData; }

        TextureAssetData& GetTextureData() { return m_TextureData; }
