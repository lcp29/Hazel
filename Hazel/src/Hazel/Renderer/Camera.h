...
namespace Hazel
{
    ...
    private:
        ...
        Camera(float fovX, float aspectRatio, float nearClip, float farClip, float orthoWidth, float orthoAspectRatio,
               float orthoNearClip, float orthoFarClip) : m_FovX(fovX), m_AspectRatio(aspectRatio),
