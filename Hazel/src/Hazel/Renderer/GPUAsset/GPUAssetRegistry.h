...
namespace Aster
{
    ...
    class GPUAssetRegistry
    {
      public:
        ...
        std::pair<std::unique_ptr<GPUAsset>, GPUAsset*>
        SetAssetAndGetTheOldAndTheNewOnes(std::unique_ptr<GPUAsset> asset)
        {
            if (!asset) { return {nullptr, nullptr}; }
